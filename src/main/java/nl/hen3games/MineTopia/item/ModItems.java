...
public class ModItems {
    ...
    public static final Item LIME_GLASS_HELMET = new ArmorBase("lime_glass_helmet", ARMOR_LIME_GLASS, 1, EntityEquipmentSlot.HEAD, Main.mthelmettab);
    public static final Item LIME_GLASS_CHESTPLATE = new ArmorBase("lime_glass_chestplate", ARMOR_LIME_GLASS, 1, EntityEquipmentSlot.CHEST, Main.mtchestplatetab);
    public static final Item LIME_GLASS_LEGGINGS = new ArmorBase("lime_glass_leggings", ARMOR_LIME_GLASS, 2, EntityEquipmentSlot.LEGS, Main.mtleggingstab);
    public static final Item LIME_GLASS_BOOTS = new ArmorBase("lime_glass_boots", ARMOR_LIME_GLASS, 1, EntityEquipmentSlot.FEET, Main.mtbootstab);
    ...
    public static final Item ORANGE_GLASS_HELMET = new ArmorBase("orange_glass_helmet", ARMOR_ORANGE_GLASS, 1, EntityEquipmentSlot.HEAD, Main.mthelmettab);
    public static final Item ORANGE_GLASS_CHESTPLATE = new ArmorBase("orange_glass_chestplate", ARMOR_ORANGE_GLASS, 1, EntityEquipmentSlot.CHEST, Main.mtchestplatetab);
    public static final Item ORANGE_GLASS_LEGGINGS = new ArmorBase("orange_glass_leggings", ARMOR_ORANGE_GLASS, 2, EntityEquipmentSlot.LEGS, Main.mtleggingstab);
    public static final Item ORANGE_GLASS_BOOTS = new ArmorBase("orange_glass_boots", ARMOR_ORANGE_GLASS, 1, EntityEquipmentSlot.FEET, Main.mtbootstab);
    ...
    public static final Item PINK_GLASS_HELMET = new ArmorBase("pink_glass_helmet", ARMOR_PINK_GLASS, 1, EntityEquipmentSlot.HEAD, Main.mthelmettab);
    public static final Item PINK_GLASS_CHESTPLATE = new ArmorBase("pink_glass_chestplate", ARMOR_PINK_GLASS, 1, EntityEquipmentSlot.CHEST, Main.mtchestplatetab);
